...
class Atomicon_Gallery {
	...
	private function __construct() {		
	    ...
	    // add_action( 'my_action', array( $this, 'action_method_name' ) );
	...
	public function register_admin_styles() {
	    ...
	    if ( isset( $this->plugin_screen_slug ) ){
			 ...
			 if ( $screen->id == $this->plugin_screen_slug ) {
			 	wp_enqueue_style( 'atomicon-gallery-admin-styles', plugins_url( 'css/admin.css', __FILE__ ) );
			 } // end if
	...
	public function register_admin_scripts() {
	    ...
	    if ( isset( $this->plugin_screen_slug ) ){
			 ...
			 $screen = get_current_screen();
			 if ( $screen->id == $this->plugin_screen_slug ) {
			 	wp_enqueue_script( 'atomicon-gallery-admin-script', plugins_url( 'js/admin.js', __FILE__ ), array( 'jquery' ) );
			 } // end if
